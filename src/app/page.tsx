              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none text-primary">
                    Gestão Clínica Simplificada para Nutricionistas
                  </h1>
                  <p className="max-w-[600px] text-foreground/80 md:text-xl">
                    ReNutri capacita nutricionistas com ferramentas para gerenciamento de pacientes e acompanhamento antropométrico detalhado.
                  </p>
                </div>
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
              <div className="space-y-2">
                ...
                <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">Otimize Sua Prática Clínica</h2>
                <p className="max-w-[900px] text-foreground/80 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  ReNutri oferece um conjunto de ferramentas essenciais para o cadastro de pacientes e avaliação clínica.
                </p>
              </div>
            </div>
