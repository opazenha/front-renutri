...
import type {
  FoodAssessmentFormData,
  FoodFrequencyFormData,
  MealRecordFormData,
} from "@/lib/schemas";
...
const counselingProfessionalOptions: CounselingProfessional[] = [
  "Endocrinologista",
  "Nutricionista",
  "Nutrólogo",
  "Ortomolecular",
...
const appetiteOptions: AppetiteLevel[] = [
  "Pouco",
  "Normal",
  "Aumentado",
  "Variável",
...
const cookingOilFatQuantityOptions: CookingOilFatQuantity[] = [
  "Pouca",
  "Moderada",
  "Muita",
];
...
const consumptionFrequencyOptions: ConsumptionFrequency[] = [
  "Diário",
  "X vezes/semana",
  "X vezes/mês",
  "Raramente",
...
export function FoodAssessmentSection({ patient }: FoodAssessmentSectionProps) {
  ...
  const form = useForm<FoodAssessmentFormData>({
    ...
    defaultValues: {
      ...
      previousNutritionalCounseling:
        latestAssessment.previousNutritionalCounseling || undefined,
      objectiveOfPreviousCounseling:
        latestAssessment.objectiveOfPreviousCounseling || "",
      counselingProfessional:
        latestAssessment.counselingProfessional || undefined,
      foodAllergiesDescribed: latestAssessment.foodAllergiesDescribed || "",
      foodIntolerancesDescribed:
        latestAssessment.foodIntolerancesDescribed || "",
      ...
      cookingOilFatQuantity:
        latestAssessment.cookingOilFatQuantity || undefined,
      ...
      dietaryRecall24h:
        latestAssessment.dietaryRecall24h?.map((m) => ({
          ...m,
          id: m.id || uuidv4(),
        })) || [],
      foodFrequency:
        latestAssessment.foodFrequency?.map((f) => ({
          ...f,
          id: f.id || uuidv4(),
        })) || [],
    },
  ...
  const {
    ...
    name: "dietaryRecall24h",
  });
  const {
    fields: frequencyFields,
    append: appendFrequency,
  ...
  function handleSubmit(data: FoodAssessmentFormData) {
    try {
      ...
      toast({
        title: "Erro",
        description:
          "Falha ao adicionar registro alimentar. Por favor, tente novamente.",
        variant: "destructive",
      });
    }
  }
  ...
  const generalHabitsFields = [
    {
      name: "previousNutritionalCounseling",
      label: "Já fez acompanhamento nutricional antes?",
      component: Select,
      options: yesNoUnknownOptions.map((o) => ({ label: o, value: o })),
      placeholder: "Selecione",
    },
    {
      name: "objectiveOfPreviousCounseling",
      label: "Qual objetivo do acompanhamento anterior?",
      component: Input,
      type: "text",
    },
    {
      name: "counselingProfessional",
      label: "Com qual profissional?",
      component: Select,
      options: counselingProfessionalOptions.map((o) => ({
        label: o,
        value: o,
      })),
      placeholder: "Selecione",
    ...
    {
      name: "foodAllergiesDescribed",
      label: "Alergias alimentares descritas",
      component: Textarea,
    },
    {
      name: "foodIntolerancesDescribed",
      label: "Intolerâncias alimentares descritas",
      component: Textarea,
    },
    {
      name: "appetite",
      label: "Apetite",
      component: Select,
      options: appetiteOptions.map((o) => ({ label: o, value: o })),
      placeholder: "Selecione",
    },
    {
      name: "mealLocation",
      label: "Local onde realiza as refeições",
      component: Input,
      type: "text",
    },
    {
    ...
    },
    {
      ...
      component: Input,
      type: "text",
      placeholder: "Ex: 2 litros, 8 copos",
    },
    {
      name: "saltUsage",
      label: "Uso de sal",
      component: Select,
      options: saltUsageOptions.map((o) => ({ label: o, value: o })),
      placeholder: "Selecione",
    },
    {
      name: "saltType",
      ...
      component: Input,
      type: "text",
      placeholder: "Ex: Refinado, Marinho, Rosa",
    },
    {
      name: "cookingOilFatUsage",
      label: "Uso de óleo/gordura para cozinhar",
      component: Input,
      type: "text",
      placeholder: "Ex: Azeite, Óleo de soja, Manteiga",
    },
    {
      name: "cookingOilFatQuantity",
      label: "Quantidade de óleo/gordura",
      component: Select,
      options: cookingOilFatQuantityOptions.map((o) => ({
        label: o,
        value: o,
      })),
      placeholder: "Selecione",
    ...
    {
      name: "sugarSweetenerUsage",
      label: "Uso de açúcar/adoçante",
      component: Input,
      type: "text",
      placeholder: "Ex: Açúcar refinado, Adoçante Xylitol",
    },
    {
      ...
      <Card className="shadow-md">
        <CardHeader>
          <CardTitle className="text-xl flex items-center">
            <PlusCircle className="mr-2 h-6 w-6 text-primary" /> Nova Avaliação
            Alimentar
          </CardTitle>
          <CardDescription>
            Registre os hábitos alimentares de {patient.name}.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
            ...
            >
              <Card>
                <CardHeader>
                  <CardTitle className="text-lg">
                    Histórico Nutricional e Hábitos Gerais
                  </CardTitle>
                </CardHeader>
                  ...
                  {generalHabitsFields.map((item, index) => (
                    <FormField
                      ...
                      render={({ field }) => {
                        ...
                        return (
                          <FormItem
                            className={`p-3 rounded-md flex flex-col sm:flex-row ${
                          ...
                          >
                            <FormLabel
                              className={`sm:w-1/3 mb-1 sm:mb-0 ${
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-lg">
                    Recordatório Alimentar 24h / Diário Alimentar
                  </CardTitle>
                </CardHeader>
                  ...
                  {recallFields.map((field, index) => (
                    ...
                    >
                      ...
                      <div className="space-y-0">
                        <FormField
                          control={form.control}
                          name={`dietaryRecall24h.${index}.mealType`}
                        ...
                        <FormField
                          control={form.control}
                          name={`dietaryRecall24h.${index}.time`}
                          render={({ field: itemField }) => (
                            <FormItem className="p-2 flex flex-col sm:flex-row sm:items-center sm:gap-4">
                              <FormLabel className="sm:w-1/3 mb-1 sm:mb-0 sm:text-right">
                                Horário
                        ...
                        <FormField
                          control={form.control}
                          name={`dietaryRecall24h.${index}.foodItem`}
                          render={({ field: itemField }) => (
                            <FormItem className="p-2 flex flex-col sm:flex-row sm:items-center sm:gap-4">
                              <FormLabel className="sm:w-1/3 mb-1 sm:mb-0 sm:text-right">
                                Alimento
                        ...
                        <FormField
                          control={form.control}
                          name={`dietaryRecall24h.${index}.quantity`}
                          render={({ field: itemField }) => (
                            <FormItem className="p-2 flex flex-col sm:flex-row sm:items-center sm:gap-4">
                              <FormLabel className="sm:w-1/3 mb-1 sm:mb-0 sm:text-right">
                                Quantidade
                        ...
                        <FormField
                          control={form.control}
                          name={`dietaryRecall24h.${index}.preparationMethod`}
                          render={({ field: itemField }) => (
                            <FormItem className="p-2 flex flex-col sm:flex-row sm:items-center sm:gap-4">
                              <FormLabel className="sm:w-1/3 mb-1 sm:mb-0 sm:text-right">
                                Modo de Preparo
                        ...
                        <FormField
                          control={form.control}
                          name={`dietaryRecall24h.${index}.observations`}
                          render={({ field: itemField }) => (
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  {frequencyFields.map((field, index) => (
                    ...
                    >
                      ...
                      <div className="space-y-0">
                        <FormField
                          control={form.control}
                          name={`foodFrequency.${index}.foodOrGroup`}
                          render={({ field: itemField }) => (
                            <FormItem className="p-2 flex flex-col sm:flex-row sm:items-center sm:gap-4">
                              <FormLabel className="sm:w-1/3 mb-1 sm:mb-0 sm:text-right">
                                Grupo Alimentar
                        ...
                        <FormField
                          control={form.control}
                          name={`foodFrequency.${index}.consumptionFrequency`}
                          render={({ field: itemField }) => (
                            <FormItem className="p-2 flex flex-col sm:flex-row sm:items-center sm:gap-4">
                              <FormLabel className="sm:w-1/3 mb-1 sm:mb-0 sm:text-right">
                              ...
                              <div className="sm:w-2/3">
                                ...
                                >
                                  ...
                                  <SelectContent>
                                    {consumptionFrequencyOptions.map((opt) => (
                                      <SelectItem key={opt} value={opt}>
                                        {opt}
                                      </SelectItem>
                                    ))}
                        ...
                        <FormField
                          control={form.control}
                          name={`foodFrequency.${index}.usualPortion`}
                          render={({ field: itemField }) => (
                            <FormItem className="p-2 flex flex-col sm:flex-row sm:items-center sm:gap-4">
                              <FormLabel className="sm:w-1/3 mb-1 sm:mb-0 sm:text-right">
                                Porção Habitual
                  ...
                  >
                    <PlusCircle className="mr-2 h-4 w-4" /> Adicionar Alimento à
                    Frequência
                  </Button>
                </CardContent>
              </Card>
        ...
        <Card className="shadow-md">
          <CardHeader>
            <CardTitle className="text-xl">
              Histórico de Avaliações Alimentares
            </CardTitle>
          </CardHeader>
          <CardContent>
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead>Apetite</TableHead>
                    <TableHead>Nº Itens Recordatório</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {patient.foodAssessments.map((record, tblIndex) => (
                    ...
                    >
                      ...
                      <TableCell>
                        {record.dietaryRecall24h?.length || 0}
                      </TableCell>
                    </TableRow>
                  ))}
                </TableBody>
